...
function getRecipesFromStorage() {
  ...
  let rawData = localStorage.getItem("recipes");
...
function initFormHandler() {
  ...
  let clearLocalStorageElement = document.querySelector("button.danger");
  // B11. TODO - Add a click event listener to clear local storage button
  clearLocalStorageElement.addEventListener("click", () => {
